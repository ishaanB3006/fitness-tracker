...
import { workoutPrograms, demoUserProgress } from "@/cms/data";
...
export function HomeClient({ workouts, mealPlans }: HomeClientProps) {
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Progress
                value={60}
                className="h-2"
                indicatorClassName="from-amber-400 to-orange-500"
              />
            </div>
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <Progress
                value={56}
                className="h-2"
                indicatorClassName="from-rose-400 to-red-500"
              />
            </div>
          </div>
        </Card>
      ...
      {quickWorkouts.length > 0 && (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {quickWorkouts.slice(0, 3).map((workout, index) => (
